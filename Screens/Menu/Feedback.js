    ...
    return (
      <ScrollView 
        refreshControl={
          ...
          <Text style={styles.title}>Daftar Feedback Masuk:</Text>
            {
              formKey.length > 0
              ?
                <FlatList
                    ...
                    return (
                      <TouchableOpacity key={index} style={styles.container}>
                        ...
                        <Text style={styles.data}>Status:</Text>
                          ...
                          <Text style={{fontSize: 12, fontWeight: 'bold', top: 5, color: 'black'}}>{tanggal.format('LLLL')}</Text>
                          <Image
                            source={{
                              uri: item.foto
              ...
              : <Text style={{fontSize: 20, color: '#858383', fontWeight: 'bold', top: 200, margin: 20, width: 350, height: 300, left: 70}}>LAPORAN KOSONG</Text>
            }
      </ScrollView>
    )
  }
